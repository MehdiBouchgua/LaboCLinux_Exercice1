CLINUX_Exercice1:	main.o mainwindow.o moc_mainwindow.o
	g++ main.o mainwindow.o moc_mainwindow.o   /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -lpthread -o CLINUX_Exercice1
main.o:	main.cpp
